...
/* --- Pin Definitions --- */
#define SERVO_PIN 18
#define TRIG_PIN 13       // Pin for the HC-SR04 Trigger
#define ECHO_PIN 12 
#define buzzer_PIN 1
#define MQ2_PIN 15
#define RELAY_PIN 2
...
void setup()
{
  ...
  pinMode(trigPin, OUTPUT); // Konfigurasi pin trig
  pinMode(echoPin, INPUT);
  pinMode(MQ2_PIN, INPUT);
  pinMode(buzzer_PIN, OUTPUT);
  pinMode(RELAY_PIN, OUTPUT);    // Set BUZZER_PIN as OUTPUT
...
void loop()
{
  ...
  PPM = analogRead(MQ2_PIN);
    ...
    // Move the servo if distance is less than 10 cm
